							...
							<table class="table style-1" id="ListDatatableView">
								...
								<tbody>
									<?php  foreach($resultStade as $stade): ?>
										<tr>
											<td>
												<h6><?=  array_search($stade,$resultStade)+1 ?></h6>
											</td>
											<td>
											...
											<td>
												<div class="d-flex action-button">
													...
													<form action="<?= $_SERVER['PHP_SELF'] ?>"  onsubmit="return  confirm('voulez-vous vraiment supprimer cet element')" method="POST">
														<button class="ml-2 btn btn-xs px-2 light btn-danger"  name="delete" value="<?= $stade['id_stade'] ?>">
															<svg width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<form action="<?= $_SERVER['PHP_SELF'] ?>" method="POST" id="form-stade" >
				...
				<div class="modal-body">
						...
						<div class="mb-3">
							...
							<input class="form-control" name="stade_capacity" type="number"  id="stade-capacity" min="0" max="100000" />
						</div>
						<div class="mb-3">
