...
$nulberreservation=$dsn->numberRow("SELECT * FROM reservation  where id_utilisateur=? ",array($iduser));
?>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="userdashboard.php">New Resrvation</a></li>
                            <li><a href="oldreservaion.php">old reservation</a></li>
                        </ul>
