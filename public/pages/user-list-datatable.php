						...
						<ul class="navbar-nav header-right main-notification">
							...
							<li class="nav-item dropdown header-profile">
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<a href="déconexion.php" class="dropdown-item ai-icon">
				...
				<div>
					...
					?>
						<div class="p-2 alert alert-success alert-dismissible fade show"  role="alert">
							<div class="d-flex justify-content-between align-center"><p class="mt-3"><strong>Success!</strong> <?php echo $_SESSION["update"] ?></p>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table class="table style-1" id="ListDatatableView">
								...
								<tbody>
									<?php $rows = $dsn->getAllrows('SELECT * FROM utilisateur INNER JOIN role ON utilisateur.role_u=role.id_role');
									foreach ($rows as $row) {
									?>
										<tr>
											<td id="id_id" class="text-center"><?php echo $row['id'] ?></td>
											...
											<td class="text-center"><span id='num_role' class="btn btn-warning"><?php echo $row['nom_role'] ?></span></td>
											<td class="text-center">
												<div class="d-flex action-button">

													<?php echo	'<button id="buttond" onclick="editTask(' . $row["id"] . ',' . $row["id_role"] . ');" type="button"  data-bs-target="#modal-task" data-bs-toggle="modal"  class="btn btn-info btn-xs light px-2">
													<i class="fa-solid fa-pen-to-square"></i>
									                </button>'; ?>
													<form action="" method="post">
														<input type="hidden" name="id_delete" value="<?php echo $row['id'] ?>">
														<button onclick="return confirm('vous voulez vraiment supprimer ce compte')" name="delete" type="submit" class="ml-2 btn btn-xs px-2 light btn-danger">
